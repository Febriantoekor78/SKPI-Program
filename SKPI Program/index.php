            ...
            <ul class="nav navbar-nav" id="main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown-header"><i class="fa fa-user"></i>&nbsp; Menu Users</li>
              ...
              <div class="row">
                <div class="col-md-6 col-md-push-6 item-caption">
                  <h2 class="h1 text-weight-light">
                   <span class="text-primary">SKPI<br>UNIVERSITAS BOROBUDUR</span>
                    </h2>
                  <h4>
                      Universitas Borobudur.
                    </h4>
                  <p>about Universitas</p>
                  </div>
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6 text-right-md item-caption">
                  <h2 class="h1 text-weight-light">
                      <span class="text-primary">More Info.<br><a href="www.borobudur.ac.id"</span>
                    </h2>
                  <h4>
                     borobudur.ac.id
                    </h4>
    ...
    <div class="mission text-center block block-pd-sm block-bg-noise">
      <div class="container">
        <h2 class="text-shadow-white">
            @coypright 081331015 SISTEM INFORMASI FAKULTAS ILMU KOMPUTER UNIVERSITAS BOROBUDUR
          </h2>
      </div>
    </div>
